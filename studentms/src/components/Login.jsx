...
const Login = () => {
    // const { id } = useParams()
    const [values, setValues] = useState({ email: '', password: '', class_code: '', })
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:3000/auth/teacherlogin', values)
            .then(result => {
                    ...
                    <div className='mb-3'>
                        ...
                        <div className='col-12'>
                            <select
                                ...
                                onChange={e => setValues({ ...values, class_code: e.target.value })}
                            >
                                {classroom.map(c => {
